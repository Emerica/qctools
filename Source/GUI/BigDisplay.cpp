...
const filter Filters[]=
{
    ...
    */
    ...
    },
    {
        ...
        {
            { Args_Type_Slider,   1,   1,   0,   1, "Line" },
            { Args_Type_Slider,  20,  20, 486,   1, "Count"},
        ...
        {
            "crop=iw:1:0:${1}:0:1,tile=1x${2}:overlap=${2}-1",
            "split[a][b];[a]crop=iw:1:0:${1}:0:1,tile=1x${2}:overlap=${2}-1,pad=iw:ih+1[a1];[b]crop=iw:1:0:${1}+1:0:1,tile=1x${2}:overlap=${2}-1,vflip[b1];[a1][b1]vstack"
        },
    },
    {
        "Zoom",
